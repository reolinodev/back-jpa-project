...
class CodeServiceTest {
    ...
    public void  saveCode() {
        ...
        codeParam.codeGrpId = 2L;
        codeParam.createdId = 3L;

        Code[] createdRows = new Code[2];
        Code[] updatedRows = new Code[1];
        Code[] deletedRows =new Code[1];

        Code createCode1 = new Code();
        createCode1.codeNm = "50개";
        createCode1.codeVal = "50";
        createCode1.memo ="페이지당 50개";
        createCode1.ord ="4";
        createCode1.useYn = "Y";
